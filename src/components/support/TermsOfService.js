      ...
      <SimpleGrid columns={{ base: 1, md: 1 }}>
        <Stack spacing={4} px="20px">
          ...
          <Text m="10px">
            ...
            <Heading as="h1" m="10px" fontSize="2xl">
            ...
            <ul>
              ...
              <li>
                <Text m="10px">
                  ...
                  Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                  &quot;Our&quot; in this Agreement) refers to SolvingZero, 152
              ...
              <li>
                <Text m="10px">
                  <strong>Website</strong> refers to SolvingZero, accessible
                  from{' '}
                  <a
                    href="https://solvingzero.com"
                    rel="external nofollow noopener noreferrer"
                    target="_blank"
                  >
                    https://solvingzero.com
                  </a>
                </Text>
              </li>
              <li>
            ...
            <ul>
              <li>
                ...
                <a
                  href="https://solvingzero.com/contact"
                  rel="external nofollow noopener noreferrer"
                  target="_blank"
                >
                  https://solvingzero.com/contact
                </a>
              </li>
            </ul>
          </Text>
